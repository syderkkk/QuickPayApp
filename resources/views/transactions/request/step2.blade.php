                ...
                <div class="p-3">
                    ...
                    <div class="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-2 mb-2 border border-slate-200">
                        <div class="flex items-center gap-2">
                            <div
                                class="bg-gradient-to-br from-green-500 to-green-700 rounded-full w-8 h-8 flex items-center justify-center text-white shrink-0">
                    ...
                    <form class="space-y-2" method="POST" action="{{ route('transactions.request.confirm') }}">
                        ...
                        <div class="space-y-0.5">
                            ...
                            <div
                                class="bg-gradient-to-r from-gray-50 to-slate-50 border border-gray-200 rounded-lg p-1.5 focus-within:ring-2 focus-within:ring-green-600 focus-within:border-transparent">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div
                                        class="bg-green-600 text-white px-2 py-0.5 rounded-md font-mono text-xs font-semibold">
                                        {{ $wallet_currency }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="space-y-0.5">
                            ...
                            <textarea name="reason" rows="2"
                                class="w-full px-2 py-1.5 bg-gray-50 border border-gray-200 rounded-lg font-mono text-xs focus:ring-2 focus:ring-green-600 focus:border-transparent resize-none"
