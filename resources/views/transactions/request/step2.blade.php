        ...
        <div class="w-full bg-[#D9D9D9] border-b-2 border-gray-300">
            <div class="max-w-2xl mx-auto flex flex-row">
                <a href="{{ route('transactions.send.step1') }}"
                    class="font-mono text-base text-gray-600 px-4 py-2 text-center">Enviar</a>
                <a href="#"
                    class="font-mono text-lg font-extrabold text-black px-4 py-2 border-b-4 border-black text-center">Solicitar</a>
            </div>
        </div>
            ...
            <div
                ...
                <form class="w-full" method="POST" action="{{ route('transactions.send.confirm') }}">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-2 mb-4 w-full">
                        ...
                        <input type="number" step="0.01" min="0.01" value="10.00" name="amount"
                        ...
                        <div class="w-full sm:w-auto flex-shrink-0">
                            <select name="currency"
                                ...
                                <option value="{{ $wallet_currency }}">{{ $wallet_currency }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-6">
                        <textarea name="reason" rows="2"
                            ...
                            placeholder="¿Para qué estás solicitando?"></textarea>
                    </div>
                    <button type="submit"
