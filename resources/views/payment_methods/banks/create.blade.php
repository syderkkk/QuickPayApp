            ...
            <form method="POST" action="{{ route('banks.store') }}"
                ...
                <div class="w-full">
                    ...
                    <select id="account_type" name="account_type" required
                        ...
                        <option value="" disabled {{ old('account_type') ? '' : 'selected' }}>Seleccione el tipo
                        </option>
                        <option value="corriente" {{ old('account_type') == 'corriente' ? 'selected' : '' }}>Corriente
                        </option>
                        <option value="ahorros" {{ old('account_type') == 'ahorros' ? 'selected' : '' }}>Ahorros
                        </option>
                    </select>
                ...
                <input name="account_number"
                    class="w-full font-mono rounded border border-gray-400 bg-[#f0f4fa] px-3 py-2 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600"
                ...
                <div class="w-full">
                    ...
                    <select name="currency" id="currency" required
                        class="block w-full rounded-md border border-gray-300 bg-white py-2 px-3 font-mono text-sm text-gray-500 placeholder-gray-400 focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb]">
                        <option value="" disabled {{ old('currency') ? '' : 'selected' }}>Seleccione la divisa
                        </option>
                        <option value="PEN" {{ old('currency') == 'soles' ? 'selected' : '' }}>Nuevo sol peruano
                        </option>
                        <option value="USD" {{ old('currency') == 'dolares' ? 'selected' : '' }}>Dolar
